/**
 * Translate ALL untranslated meanings in curriculumData.ts - Batch 2
 * Expanded dictionary with 100+ entries
 */
...
const dict = {
  ...
  '來': { 'zh-TW': '來源', 'zh-CN': '來源', 'en': 'Come', 'ja': '来ます', 'ko': '오다', 'es': 'Venir', 'fr': 'Venir', 'de': 'Kommen' },
